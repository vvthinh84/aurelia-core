...
export class BackToSchool {
    ...
    activate() {
        ...
        // return Promise.all([this.webQuaySoService.GetKetQuaKhachhangtrunggiai({ "Tuan": 1, "LoaiQua": 1, "EventId": 1 })])
        //     .then((rs) => {
        //          this.DSKhachHangTrung1 = rs[0].Data.DsKhachhangsDaTrung.filter(x =>x.LoaiQua==1);
    ...
    attached() {
        ...
        $('#el_week').on('change', () => {
            ...
            this.Danhsachkhachhangtheotuan3();
        });
    }
